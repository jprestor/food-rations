...
export default async function Footer() {
  ...
  return (
    <footer className="p-4 bg-primary text-primary-content">
      <div className="container footer items-center">
